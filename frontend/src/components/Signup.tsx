      ...
      <div className="relative z-10 grid w-full max-w-4xl gap-12 md:grid-cols-[1.1fr,1fr]">
        <div className="space-y-4 text-center md:text-left">
          ...
          <p className="max-w-md text-sm text-white/60">
            Connect your GitHub, configure once, and then push to deploy.
            Perfect for personal projects, client sites, and production apps.
          </p>
        </div>

        <div className="relative rounded-2xl border border-white/10 bg-[#00A63E]/5 p-6 shadow-[0_0_50px_rgba(0,0,0,0.9)] backdrop-blur-md transition-all duration-500 hover:border-green-500/60 hover:shadow-[0_0_55px_rgba(22,163,74,0.6)]">
